...
func TestBoleto(t *testing.T) {
	tests := []struct {
		...
		{
			name:                 "Valid Barcode with 1997 date",
			barcode:              "71298000000000341667939598174962983042386668",
			expectedBank:         "712",
			expectedCurr:         "9",
			expectedYear:         1997,
			expectedMonth:        time.October,
			expectedDay:          7,
			expectedValue:        34166,
			expectedFree:         "7939598174962983042386668",
			expectedWritableLine: "71297939519817496298930423866687800000000034166",
		},
	}
